...
class MapViewController: UIViewController, CLLocationManagerDelegate, MKMapViewDelegate {
    ...
    @IBAction func saveProfile(_ sender: Any) {
        ...
        print("my id \(id)")
        var myProfile = serviceProviderPrpfile(id: id!, commericalNumber: commericalNumber.text!, geolat: geolat!, geolng: geolng!, administrativeArea: administrativeArea!, country: country!)
